...
void CLab2pripremaView::Saksija(CDC* pDC)
{
	...
	CPoint donjiDeoSaksije[] = { CPoint(8*kvadrat, 18*kvadrat), CPoint(12*kvadrat, 18*kvadrat), CPoint(11.5*kvadrat, 20*kvadrat), CPoint(8.5*kvadrat, 20*kvadrat) };
	pDC->Rectangle(7.5 * kvadrat, 17.2 * kvadrat, 12.5 * kvadrat, 18 * kvadrat);
...
void CLab2pripremaView::Kaktus(CDC* pDC)
{
	...
	Scale(pDC, 0.5f, 0.5f, false);
	Translate(pDC, 2 * kvadrat, -2 * kvadrat, false);
	Rotate(pDC, this->drugiUgao, false);
	Scale(pDC, 2.0f, 2.0f, false);
	pDC->PlayMetaFile(this->svetliDeo, CRect(-10, 0, 10, -37.5));
	Rotate(pDC, -PI / 2 - drugiUgao, false);
	Scale(pDC, 0.5f, 0.5f, false);
	Scale(pDC, 2.0f, 2.0f, false);
	pDC->PlayMetaFile(this->tamniDeo, CRect(-10, 0, 10, 37.5));
	Scale(pDC, 0.5f, 0.5f, false);
	Scale(pDC, 2.0f, 2.0f, false);
	pDC->Ellipse(-5, -5, 5, 5);
	Rotate(pDC, PI / 2, false);
	...
	Scale(pDC, 0.5f, 0.5f, false);
	Translate(pDC, -7 * kvadrat, 0, false);
	Scale(pDC, 2.0f, 2.0f, false);
	pDC->PlayMetaFile(this->tamniDeo, CRect(-10, 0, 10, -37.5));
	Rotate(pDC, PI / 2, false);
	Scale(pDC, 0.5f, 0.5f, false);
	...
	/*Translate(pDC, 10 * kvadrat, 17 * kvadrat, false);
	Rotate(pDC, prviUgao, false);
	pDC->PlayMetaFile(this->svetliDeo, CRect(-30, 0, 30, -75));
	pDC->Ellipse(-10, -10, 10, 10);
	Translate(pDC, 0, -3 * kvadrat, false);
	pDC->PlayMetaFile(this->tamniDeo, CRect(-12, 0, 12, -75));
	Rotate(pDC, PI / 4, false);
	pDC->PlayMetaFile(this->tamniDeo, CRect(-12, 0, 12, -75));
	Rotate(pDC, -PI / 2, false);
	pDC->PlayMetaFile(this->tamniDeo, CRect(-12, 0, 12, -75));
	...
	Translate(pDC, 2 * kvadrat, -2 * kvadrat, false);
	Rotate(pDC, this->drugiUgao, false);
	pDC->PlayMetaFile(this->svetliDeo, CRect(-20, 0, 20, -75));
	Rotate(pDC, -PI/2-drugiUgao, false);
	pDC->PlayMetaFile(this->tamniDeo, CRect(-20, 0, 20, 75));
	pDC->Ellipse(-10, -10, 10, 10);
	Rotate(pDC, PI / 2, false);
	Translate(pDC, 3 * kvadrat, 0, false);
	Rotate(pDC, PI / 4, false);
	...
	Rotate(pDC, -PI / 2, false);
	Translate(pDC, 0, -3 * kvadrat, false);
	pDC->PlayMetaFile(this->tamniDeo, CRect(-30, 0, 30, -75));
	pDC->Ellipse(-10, -10, 10, 10);*/
